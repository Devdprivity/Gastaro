...
Route::middleware('auth')->group(function () {
    ...
    // Nueva ruta para perfil móvil optimizado
    Route::get('settings/mobile-profile', function () {
        return Inertia::render('settings/mobile-profile', [
            'mustVerifyEmail' => config('fortify.features.emailVerification'),
