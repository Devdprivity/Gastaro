...
export default function GastaroPay({ auth }: GastaroPayProps) {
    return (
        <AdaptiveLayout>
            <Head title="Gastaro Pay" />
            ...
            <div className="md:hidden h-full flex flex-col overflow-hidden">
                ...
                <div className="flex-none bg-white border-b border-gray-200 px-4 py-4">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-xl font-bold text-gray-900">Gastaro Pay</h1>
                    </div>
                </div>
                ...
                <div className="flex-1 overflow-hidden px-4 py-4 pb-24">
                    <div className="h-full flex flex-col items-center justify-center space-y-8">
                        ...
                        <div className="text-center">
                            <div className="w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden border-6 border-orange-500 bg-orange-100 flex items-center justify-center shadow-2xl">
                                {auth.user.avatar ? (
                                    <img
                            ...
                            {/* Nombre del usuario */}
                            <h2 className="text-2xl font-bold text-gray-900 mb-2">{auth.user.name}</h2>
                            <p className="text-gray-600">Tu tarjeta Gastaro Pay</p>
                        </div>
                        ...
                        <div className="w-full max-w-sm space-y-3 flex flex-col items-center">
                            <button className="w-auto px-8 py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-xl transition-colors">
                                Gastaro Pay
                            </button>
            ...
            <div className="hidden md:block p-8">
                <h1 className="text-2xl font-bold mb-4">Gastaro Pay</h1>
                <p className="text-gray-600">Vista de escritorio en desarrollo...</p>
            </div>

            {/* Estilos CSS para la tarjeta flip */}
